#!/usr/bin/env python3
"""
Fixed test script for AD Multi-Agent API
Tests the updated Gemini 2.5 models with correct base64 encoding
"""
import requests
import time
import json
...
def test_upload():
    """Test the upload endpoint with correct format"""
    print("=" * 80)
...
def poll_analysis(session_id, max_attempts=40, interval=3):
