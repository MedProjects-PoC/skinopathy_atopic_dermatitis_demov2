...
VISION_AGENT_CONFIG_GEMINI_FLASH = AgentConfig(
    ...
    provider=ModelProvider.VERTEX_AI,
    temperature=0.2,
    max_tokens=8000,  # Increased to handle full A-I section response (9 detailed sections)
...
EASI_AGENT_CONFIG_GEMINI = AgentConfig(
    ...
    max_tokens=6000,  # Increased to handle full regional breakdown + clinical interpretation
    cost_per_1m_input=0.075,
    cost_per_1m_output=0.30,
    retry_attempts=3,
    timeout_seconds=45,
